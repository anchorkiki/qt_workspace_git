...
QT_MOC_LITERAL(3, 26, 9), // "stopTimer"
QT_MOC_LITERAL(4, 36, 10), // "collidePos"
QT_MOC_LITERAL(5, 47, 12) // "delayHideWin"

    },
    "MyView\0animationFinished\0\0stopTimer\0"
    "collidePos\0delayHideWin"
};
...
void MyView::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 1: _t->stopTimer((*reinterpret_cast< QPointF(*)>(_a[1]))); break;
        case 2: _t->delayHideWin(); break;
        default: ;
        }
    } else if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            typedef void (MyView::*_t)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&MyView::animationFinished)) {
                *result = 0;
                return;
            }
        }
